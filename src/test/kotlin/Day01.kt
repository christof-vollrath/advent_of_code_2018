...
She sounded pretty worried when she called you down here. "At 500-year intervals into the past,
    ...
    describe("part 1") {
        given("example input") {
            ...
            onData("call for action %s", with = *testData) { input, expected ->
                val result = processFrequencyChanges(input)
                it("returns $expected") {
